...
class BaseApi(api_client.Api):
    ...
    def _register_new_function_mapped_args(
        self,
        name: str,
        inference_url: str,
    ...
    async def _aregister_new_function_oapg(
        self,
    ...
    def _register_new_function_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RegisterNewFunctionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aregister_new_function(
        self,
        name: str,
        inference_url: str,
        health_uri: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._register_new_function_mapped_args(
            name=name,
        ...
        return await self._aregister_new_function_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def register_new_function(
        ...
        return self._register_new_function_oapg(
            body=args.body,
        )

class RegisterNewFunction(BaseApi):
    ...
    async def aregister_new_function(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aregister_new_function(
            name=name,
            inference_url=inference_url,
            health_uri=health_uri,
            inference_port=inference_port,
    ...
    def register_new_function(
        ...
        raw_response = self.raw.register_new_function(
            name=name,
            inference_url=inference_url,
            health_uri=health_uri,
            inference_port=inference_port,
