...
class RequiredFunctionDeploymentRequest(TypedDict):
    # Deployment specs with Backend, GPU, instance-type, etc. details
    deploymentSpecifications: typing.List[GpuSpecificationDto]

class OptionalFunctionDeploymentRequest(TypedDict, total=False):
    pass

class FunctionDeploymentRequest(RequiredFunctionDeploymentRequest, OptionalFunctionDeploymentRequest):
    pass
