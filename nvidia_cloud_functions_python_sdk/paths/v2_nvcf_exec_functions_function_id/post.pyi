...
from nvidia_cloud_functions_python_sdk.model.invoke_function_request import InvokeFunctionRequest as InvokeFunctionRequestSchema
from nvidia_cloud_functions_python_sdk.model.request_header_dto import RequestHeaderDto as RequestHeaderDtoSchema

from nvidia_cloud_functions_python_sdk.type.request_header_dto import RequestHeaderDto
from nvidia_cloud_functions_python_sdk.type.invoke_function_request import InvokeFunctionRequest
from nvidia_cloud_functions_python_sdk.type.invoke_function_response import InvokeFunctionResponse

from ...api_client import Dictionary
from nvidia_cloud_functions_python_sdk.pydantic.invoke_function_request import InvokeFunctionRequest as InvokeFunctionRequestPydantic
...
from nvidia_cloud_functions_python_sdk.pydantic.request_header_dto import RequestHeaderDto as RequestHeaderDtoPydantic
...
# body param
SchemaForRequestBodyApplicationJson = InvokeFunctionRequestSchema


request_body_invoke_function_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _call_function_mapped_args(
        self,
        request_body: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        function_id: str,
        request_header: typing.Optional[RequestHeaderDto] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if request_body is not None:
            _body["requestBody"] = request_body
        if request_header is not None:
            _body["requestHeader"] = request_header
        args.body = _body
    ...
    async def _acall_function_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/exec/functions/{functionId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_invoke_function_request.serialize(body, content_type)
...
class CallFunctionRaw(BaseApi):
    ...
    async def acall_function(
        ...
        **kwargs,
        ...
        args = self._call_function_mapped_args(
            request_body=request_body,
            function_id=function_id,
            request_header=request_header,
        )
        return await self._acall_function_oapg(
            body=args.body,
    ...
    def call_function(
        ...
        return self._call_function_oapg(
            body=args.body,
            path_params=args.path,
        )

class CallFunction(BaseApi):
    ...
    async def acall_function(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acall_function(
            request_body=request_body,
            function_id=function_id,
            request_header=request_header,
            **kwargs,
    ...
    def call_function(
        ...
        raw_response = self.raw.call_function(
            request_body=request_body,
            function_id=function_id,
            request_header=request_header,
        )
