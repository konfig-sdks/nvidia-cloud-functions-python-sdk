...
class BaseApi(api_client.Api):
    ...
    def _function_version_authorizations_mapped_args(
        self,
        function_id: str,
    ...
    async def _afunction_version_authorizations_oapg(
        self,
    ...
    def _function_version_authorizations_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class FunctionVersionAuthorizationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afunction_version_authorizations(
        self,
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._function_version_authorizations_mapped_args(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._afunction_version_authorizations_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def function_version_authorizations(
        self,
        function_id: str,
        function_version_id: str,
    ) -> typing.Union[
        ...
        return self._function_version_authorizations_oapg(
            path_params=args.path,
        )

class FunctionVersionAuthorizations(BaseApi):
    ...
    async def afunction_version_authorizations(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afunction_version_authorizations(
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
        )
    ...
    def function_version_authorizations(
        ...
        raw_response = self.raw.function_version_authorizations(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        if validate:
