...
class BaseApi(api_client.Api):
    ...
    def _get_version_details_mapped_args(
        self,
        function_id: str,
    ...
    async def _aget_version_details_oapg(
        self,
...
class GetVersionDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_version_details(
        self,
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._get_version_details_mapped_args(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._aget_version_details_oapg(
    ...
    def get_version_details(
        ...
        return self._get_version_details_oapg(
            path_params=args.path,
        )

class GetVersionDetails(BaseApi):
    ...
    async def aget_version_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_version_details(
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
        )
    ...
    def get_version_details(
        ...
        raw_response = self.raw.get_version_details(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        if validate:
