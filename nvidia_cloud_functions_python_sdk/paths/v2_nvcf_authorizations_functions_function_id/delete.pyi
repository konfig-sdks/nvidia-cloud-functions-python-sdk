...
class BaseApi(api_client.Api):
    ...
    def _delete_all_extra_for_function_mapped_args(
        self,
        function_id: str,
    ...
    async def _adelete_all_extra_for_function_oapg(
        self,
    ...
    def _delete_all_extra_for_function_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteAllExtraForFunctionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_all_extra_for_function(
        self,
        function_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_all_extra_for_function_mapped_args(
            function_id=function_id,
        )
        return await self._adelete_all_extra_for_function_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_all_extra_for_function(
        self,
        function_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._delete_all_extra_for_function_oapg(
            path_params=args.path,
        )

class DeleteAllExtraForFunction(BaseApi):
    ...
    async def adelete_all_extra_for_function(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_all_extra_for_function(
            function_id=function_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_all_extra_for_function(
        ...
        raw_response = self.raw.delete_all_extra_for_function(
            function_id=function_id,
        )
        if validate:
            return AuthorizedPartiesResponsePydantic(**raw_response.body)
