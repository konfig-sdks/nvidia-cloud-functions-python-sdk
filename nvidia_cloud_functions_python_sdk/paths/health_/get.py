...
from nvidia_cloud_functions_python_sdk.model.health_component import HealthComponent as HealthComponentSchema

from nvidia_cloud_functions_python_sdk.type.health_component import HealthComponent

from ...api_client import Dictionary
from nvidia_cloud_functions_python_sdk.pydantic.health_component import HealthComponent as HealthComponentPydantic

from . import path

SchemaFor200ResponseBodyApplicationJson = HealthComponentSchema
...
class GetInfo(BaseApi):
    ...
    async def aget_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> HealthComponentPydantic:
        raw_response = await self.raw.aget_info(
            **kwargs,
        )
        if validate:
            return HealthComponentPydantic(**raw_response.body)
        return api_client.construct_model_instance(HealthComponentPydantic, raw_response.body)
