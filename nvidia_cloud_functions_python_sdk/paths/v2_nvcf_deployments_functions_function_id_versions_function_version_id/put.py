...
class UpdateSpecsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specs(
        self,
        deployment_specifications: typing.List[GpuSpecificationDto],
        function_id: str,
        function_version_id: str,
    ...
    def update_specs(
        ...
        return self._update_specs_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecs(BaseApi):
    ...
    async def aupdate_specs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_specs(
            deployment_specifications=deployment_specifications,
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
    ...
    def update_specs(
        ...
        raw_response = self.raw.update_specs(
            deployment_specifications=deployment_specifications,
            function_id=function_id,
            function_version_id=function_version_id,
        )
