...
from nvidia_cloud_functions_python_sdk.model.authorized_parties_request import AuthorizedPartiesRequest as AuthorizedPartiesRequestSchema
...
from nvidia_cloud_functions_python_sdk.type.authorized_parties_request import AuthorizedPartiesRequest
...
from nvidia_cloud_functions_python_sdk.pydantic.authorized_parties_request import AuthorizedPartiesRequest as AuthorizedPartiesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AuthorizedPartiesRequestSchema


request_body_authorized_parties_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _authorize_function_accounts_mapped_args(
        self,
        authorized_parties: typing.List[AuthorizedPartyDto],
        function_id: str,
        ...
        if authorized_parties is not None:
            _body["authorizedParties"] = authorized_parties
        args.body = _body
    ...
    async def _aauthorize_function_accounts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/authorizations/functions/{functionId}/versions/{functionVersionId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_authorized_parties_request.serialize(body, content_type)
    ...
    def _authorize_function_accounts_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AuthorizeFunctionAccountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aauthorize_function_accounts(
        self,
        authorized_parties: typing.List[AuthorizedPartyDto],
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._authorize_function_accounts_mapped_args(
            authorized_parties=authorized_parties,
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._aauthorize_function_accounts_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def authorize_function_accounts(
        self,
        authorized_parties: typing.List[AuthorizedPartyDto],
        function_id: str,
        function_version_id: str,
        ...
        return self._authorize_function_accounts_oapg(
            body=args.body,
            path_params=args.path,
        )

class AuthorizeFunctionAccounts(BaseApi):
    ...
    async def aauthorize_function_accounts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aauthorize_function_accounts(
            authorized_parties=authorized_parties,
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
    ...
    def authorize_function_accounts(
        ...
        raw_response = self.raw.authorize_function_accounts(
            authorized_parties=authorized_parties,
            function_id=function_id,
            function_version_id=function_version_id,
        )
