...
from nvidia_cloud_functions_python_sdk.model.function_invocation_invoke_function200_response1 import FunctionInvocationInvokeFunction200Response1 as FunctionInvocationInvokeFunction200Response1Schema
...
from nvidia_cloud_functions_python_sdk.type.function_invocation_invoke_function200_response1 import FunctionInvocationInvokeFunction200Response1
...
from nvidia_cloud_functions_python_sdk.pydantic.function_invocation_invoke_function200_response1 import FunctionInvocationInvokeFunction200Response1 as FunctionInvocationInvokeFunction200Response1Pydantic
...
SchemaFor200ResponseBodyTextEventStream = FunctionInvocationInvokeFunction200Response1Schema
...
class BaseApi(api_client.Api):
    ...
    def _invoke_function_0_mapped_args(
        self,
        function_id: str,
        version_id: str,
    ...
    async def _ainvoke_function_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/pexec/functions/{functionId}/versions/{versionId}',
            body=body,
            headers=_headers,
        )
...
class InvokeFunction0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoke_function_0(
        self,
        function_id: str,
        version_id: str,
        nvcf_input_asset_references: typing.Optional[typing.List[str]] = None,
    ...
    def invoke_function_0(
        ...
        return self._invoke_function_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class InvokeFunction0(BaseApi):
    ...
    async def ainvoke_function_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainvoke_function_0(
            function_id=function_id,
            version_id=version_id,
            nvcf_input_asset_references=nvcf_input_asset_references,
            nvcf_poll_seconds=nvcf_poll_seconds,
    ...
    def invoke_function_0(
        ...
        raw_response = self.raw.invoke_function_0(
            function_id=function_id,
            version_id=version_id,
            nvcf_input_asset_references=nvcf_input_asset_references,
            nvcf_poll_seconds=nvcf_poll_seconds,
