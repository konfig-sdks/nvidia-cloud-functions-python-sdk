...
class BaseApi(api_client.Api):
    ...
    def _authorize_function_accounts_0_mapped_args(
        self,
    ...
    async def _aauthorize_function_accounts_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/authorizations/functions/{functionId}',
            body=body,
            headers=_headers,
        )
    ...
    def _authorize_function_accounts_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AuthorizeFunctionAccounts0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aauthorize_function_accounts_0(
        self,
        authorized_parties: typing.List[AuthorizedPartyDto],
        function_id: str,
        **kwargs,
        ...
        args = self._authorize_function_accounts_0_mapped_args(
            authorized_parties=authorized_parties,
            function_id=function_id,
        )
        return await self._aauthorize_function_accounts_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def authorize_function_accounts_0(
        self,
        authorized_parties: typing.List[AuthorizedPartyDto],
        function_id: str,
    ) -> typing.Union[
        ...
        return self._authorize_function_accounts_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class AuthorizeFunctionAccounts0(BaseApi):
    ...
    async def aauthorize_function_accounts_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aauthorize_function_accounts_0(
            authorized_parties=authorized_parties,
            function_id=function_id,
            **kwargs,
        )
    ...
    def authorize_function_accounts_0(
        ...
        raw_response = self.raw.authorize_function_accounts_0(
            authorized_parties=authorized_parties,
            function_id=function_id,
        )
        if validate:
