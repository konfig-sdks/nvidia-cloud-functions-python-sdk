...
class BaseApi(api_client.Api):
    ...
    def _delete_extra_for_function_version_mapped_args(
        self,
        function_id: str,
    ...
    async def _adelete_extra_for_function_version_oapg(
        self,
    ...
    def _delete_extra_for_function_version_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteExtraForFunctionVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_extra_for_function_version(
        self,
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._delete_extra_for_function_version_mapped_args(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._adelete_extra_for_function_version_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_extra_for_function_version(
        self,
        function_id: str,
        function_version_id: str,
    ) -> typing.Union[
        ...
        return self._delete_extra_for_function_version_oapg(
            path_params=args.path,
        )

class DeleteExtraForFunctionVersion(BaseApi):
    ...
    async def adelete_extra_for_function_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_extra_for_function_version(
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
        )
    ...
    def delete_extra_for_function_version(
        ...
        raw_response = self.raw.delete_extra_for_function_version(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        if validate:
