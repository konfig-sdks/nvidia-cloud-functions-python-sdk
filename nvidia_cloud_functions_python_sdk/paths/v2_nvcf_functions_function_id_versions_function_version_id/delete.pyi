...
class BaseApi(api_client.Api):
    ...
    def _delete_function_version_mapped_args(
        self,
        function_id: str,
    ...
    async def _adelete_function_version_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/functions/{functionId}/versions/{functionVersionId}',
            headers=_headers,
        )
    ...
    def _delete_function_version_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteFunctionVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_function_version(
        self,
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._delete_function_version_mapped_args(
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._adelete_function_version_oapg(
    ...
    def delete_function_version(
        ...
        return self._delete_function_version_oapg(
            path_params=args.path,
        )

class DeleteFunctionVersion(BaseApi):
    ...
    async def adelete_function_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_function_version(
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
        )
    ...
    def delete_function_version(
        ...
        raw_response = self.raw.delete_function_version(
            function_id=function_id,
            function_version_id=function_version_id,
        )
