...
class RequiredAuthorizedPartiesRequest(TypedDict):
    # Parties authorized to invoke function
    authorizedParties: typing.List[AuthorizedPartyDto]

class OptionalAuthorizedPartiesRequest(TypedDict, total=False):
    pass

class AuthorizedPartiesRequest(RequiredAuthorizedPartiesRequest, OptionalAuthorizedPartiesRequest):
    pass
