...
class BaseApi(api_client.Api):
    ...
    def _remove_from_function_authorization_mapped_args(
        self,
    ...
    async def _aremove_from_function_authorization_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/authorizations/functions/{functionId}/remove',
            body=body,
            headers=_headers,
        )
    ...
    def _remove_from_function_authorization_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RemoveFromFunctionAuthorizationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_function_authorization(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
        **kwargs,
        ...
        args = self._remove_from_function_authorization_mapped_args(
            authorized_party=authorized_party,
            function_id=function_id,
        )
        return await self._aremove_from_function_authorization_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def remove_from_function_authorization(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
    ) -> typing.Union[
        ...
        return self._remove_from_function_authorization_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveFromFunctionAuthorization(BaseApi):
    ...
    async def aremove_from_function_authorization(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_function_authorization(
            authorized_party=authorized_party,
            function_id=function_id,
            **kwargs,
        )
    ...
    def remove_from_function_authorization(
        ...
        raw_response = self.raw.remove_from_function_authorization(
            authorized_party=authorized_party,
            function_id=function_id,
        )
        if validate:
