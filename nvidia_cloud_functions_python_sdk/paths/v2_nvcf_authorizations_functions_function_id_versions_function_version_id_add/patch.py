...
class BaseApi(api_client.Api):
    ...
    def _add_account_to_function_version_mapped_args(
        self,
    ...
    async def _aadd_account_to_function_version_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/authorizations/functions/{functionId}/versions/{functionVersionId}/add',
            body=body,
            headers=_headers,
        )
    ...
    def _add_account_to_function_version_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddAccountToFunctionVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_account_to_function_version(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
        function_version_id: str,
        **kwargs,
        ...
        args = self._add_account_to_function_version_mapped_args(
            authorized_party=authorized_party,
            function_id=function_id,
            function_version_id=function_version_id,
        )
        return await self._aadd_account_to_function_version_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_account_to_function_version(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
        function_version_id: str,
        ...
        return self._add_account_to_function_version_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddAccountToFunctionVersion(BaseApi):
    ...
    async def aadd_account_to_function_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_account_to_function_version(
            authorized_party=authorized_party,
            function_id=function_id,
            function_version_id=function_version_id,
            **kwargs,
    ...
    def add_account_to_function_version(
        ...
        raw_response = self.raw.add_account_to_function_version(
            authorized_party=authorized_party,
            function_id=function_id,
            function_version_id=function_version_id,
        )
