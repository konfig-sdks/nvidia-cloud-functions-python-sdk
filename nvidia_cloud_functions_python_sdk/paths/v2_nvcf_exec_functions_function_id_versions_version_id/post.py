...
VersionIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'functionId': typing.Union[FunctionIdSchema, str, uuid.UUID, ],
        'versionId': typing.Union[VersionIdSchema, str, uuid.UUID, ],
    }
)
    ...
    async def _ainvoke_function_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/exec/functions/{functionId}/versions/{versionId}',
            body=body,
            headers=_headers,
        )
