...
class BaseApi(api_client.Api):
    ...
    def _add_account_to_function_mapped_args(
        self,
    ...
    async def _aadd_account_to_function_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/nvcf/authorizations/functions/{functionId}/add',
            body=body,
            headers=_headers,
        )
    ...
    def _add_account_to_function_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddAccountToFunctionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_account_to_function(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
        **kwargs,
        ...
        args = self._add_account_to_function_mapped_args(
            authorized_party=authorized_party,
            function_id=function_id,
        )
        return await self._aadd_account_to_function_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_account_to_function(
        self,
        authorized_party: AuthorizedPartyDto,
        function_id: str,
    ) -> typing.Union[
        ...
        return self._add_account_to_function_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddAccountToFunction(BaseApi):
    ...
    async def aadd_account_to_function(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_account_to_function(
            authorized_party=authorized_party,
            function_id=function_id,
            **kwargs,
        )
    ...
    def add_account_to_function(
        ...
        raw_response = self.raw.add_account_to_function(
            authorized_party=authorized_party,
            function_id=function_id,
        )
        if validate:
